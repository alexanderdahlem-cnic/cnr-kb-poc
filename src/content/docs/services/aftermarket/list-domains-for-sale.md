...
-   buy\_now: The domain will be offered at a set price on the aftermarket, a buyer can buy the domain directly without intervention of the seller.
-   make\_offer: The domain has a set minimum price which needs to be matched for a sale, however the buyer can offer a price for which he is willing to buy the domain.
...
Sender address: noreply@aftermarketapproval.com  
Subject: DOMAIN LISTING APPROVAL AND PRE-AUTHORIZATION FOR DOMAIN NAME TRANSFER

If several domains with the same Admin Contact are added, only one FOA email for these domains will be sent.

The respective URL for approving Sedo listings is [http://sedo.aftermarketapproval.com/](http://sedo.aftermarketapproval.com/)
