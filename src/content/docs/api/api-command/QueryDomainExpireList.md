...
The command _QueryDomainExpireList_ is available via the following gateways:
...
<pre class="api-io__code"><code>COMMAND = QueryDomainExpireList</code></pre></div>
...
<div class="api-io api-io--command"><span class="api-io__label">Command</span>
<pre class="api-io__code"><code>COMMAND = QueryDomainExpireList
DAYS = (INT)
MINDATE = (DATE)
INCLUDESUB = 0|1
ONLYSUB = 0|1
