...
The command _QueryJobList_ is available via the following gateways:
...
<pre class="api-io__code"><code>COMMAND = QueryJobList</code></pre></div>
...
<div class="api-io api-io--command"><span class="api-io__label">Command</span>
<pre class="api-io__code"><code>COMMAND = QueryJobList
COMMANDNAME = (TEXT)
STATUSCODE = (INT)
WIDE = 0|1
GENERATELIST = 0|1
