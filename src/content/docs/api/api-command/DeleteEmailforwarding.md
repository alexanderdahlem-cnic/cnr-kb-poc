...
The command _DeleteEmailforwarding_ is available via the following gateways:
...
<pre class="api-io__code"><code>COMMAND = DeleteEmailforwarding
EMAILADDRESS = (TEXT)
DESTINATION = (TEXT)</code></pre></div>
