...
The command _StatusEmailaddress_ is available via the following gateways:
...
<pre class="api-io__code"><code>COMMAND = StatusEmailaddress
EMAILADDRESS = (EMAIL)</code></pre></div>
